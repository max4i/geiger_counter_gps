...
class ModernSerialReaderApp:
    ...
    def setup_config(self):
        ...
        self.APP_TITLE = "🚀 Wer. 2.0 DRONE GPS GEIGER - 15LBOT"
    ...
    def create_control_panel(self, parent):
        ...
        # Logo 2 - logo.jpg (NA GÓRZE) - WIĘKSZE, DOPASOWANE DO SZEROKOŚCI
        try:
            logo2_path = resource_path("logo.jpg")
            if os.path.exists(logo2_path):
                logo2_img = Image.open(logo2_path)
                # Ustaw przezroczystość dla białego koloru
                logo2_img = logo2_img.convert("RGBA")
                logo2_data = logo2_img.getdata()

                new_data = []
                for item in logo2_data:
                    # Jeśli pixel jest biały (lub prawie biały), ustaw na przezroczysty
                ...
                # Zwiększenie rozmiaru logo - szerokość dopasowana do ramki (około 160px)
                ...
                logo2_label.pack(pady=(0, 5))  # Tylko dolny margines
        except Exception as e:
            print(f"Błąd ładowania logo2: {e}")

        # Logo 1 - 15lbot.jpg (POD LOGO.JPG) - WIĘKSZE, DOPASOWANE DO SZEROKOŚCI
        try:
            ...
            if os.path.exists(logo1_path):
                ...
                logo1_label.pack()  # Bez marginesu
        except Exception as e:
    ...
    def create_monitoring_tab(self):
        ...
        graph_frame = ttk.LabelFrame(monitor_tab, text=" Historia dawki - Wykres słupkowy ", padding=10)
    ...
    def create_data_grid(self, parent):
        ...
        # ZWIĘKSZONA CZCIONKA dla dawki uśrednionej - 2x większa (24 zamiast 12)
...
4. Tutaj zobaczysz informacje o punktach pomiarowych w czasie rzeczywistym
...
"""
        ...
        # Kolorowanie tekstu
        self.map_preview_text.tag_add("green", "9.0", "9.1")  # Zielona kropka
        self.map_preview_text.tag_add("green", "9.2", "9.9")  # "ZIELONY"

        self.map_preview_text.tag_add("orange", "10.0", "10.1")  # Pomarańczowa kropka
        self.map_preview_text.tag_add("orange", "10.2", "10.13")  # "POMARAŃCZOWY"

        self.map_preview_text.tag_add("red", "11.0", "11.1")  # Czerwona kropka
        self.map_preview_text.tag_add("red", "11.2", "11.9")  # "CZERWONY"

        self.map_preview_text.tag_add("blue", "12.0", "12.1")  # Niebieska kropka
        self.map_preview_text.tag_add("blue", "12.2", "12.7")  # "Linia"
    ...
    def setup_plot(self):
        ...
        self.ax.set_xlabel('Ostatnie pomiary', fontsize=10)
    ...
    def start_auto_map_update(self):
        ...
        if self.auto_map_update:
            ...
            # ZMIENIONE: 15 sekund zamiast 30
...
"""
        ...
        self.map_preview_text.tag_add("green", "5.2", "5.9")  # "ZIELONY"
        self.map_preview_text.tag_add("orange", "6.2", "6.13")  # "POMARAŃCZOWY"
        self.map_preview_text.tag_add("red", "7.2", "7.9")  # "CZERWONY"
    ...
    def update_plot(self, dose_value):
        """Aktualizuje wykres SŁUPKOWY - POPRAWIONE"""
        ...
        if len(self.dose_history) > 0:
            # Wykres słupkowy
            bars = self.ax.bar(range(len(self.dose_history)), self.dose_history,
        ...
        # POPRAWIONA SKALA - zawsze od 0
        if self.dose_history:
            y_max = max(self.dose_history)
            y_min = 0  # Zawsze zaczynaj od zera!

            # Jeśli wszystkie wartości są bardzo niskie, ustaw rozsądne maksimum
            if y_max < 0.15:
                y_max = 0.15  # Minimum dla skali gdy wartości są niskie

            margin = y_max * 0.1  # 10% marginesu
            self.ax.set_ylim(y_min, y_max + margin)
        else:
            # Domyślna skala gdy brak danych
            self.ax.set_ylim(0, 0.2)

        # Etykiety osi X
        if len(self.dose_history) > 10:
            self.ax.set_xticks(range(0, len(self.dose_history), max(1, len(self.dose_history) // 10)))
    ...
    def export_kml(self):
        ...
        try:
            ...
            for color, style_elem in styles.items():
                ...
                if color == 'green':
                    color_elem.text = 'ff00ff00'  # KML używa formatu aabbggrr
                elif color == 'orange':
                    color_elem.text = 'ff0080ff'  # Pomarańczowy
                else:  # red
                    color_elem.text = 'ff0000ff'  # Czerwony
            ...
            for data in valid_points:
                try:
                    ...
                    # Określ styl na podstawie dawki
                    if dose < 0.15:
